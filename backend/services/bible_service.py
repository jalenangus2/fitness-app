...
DAILY_VERSES = [
    ...
    "PSA.27.1", "1PE.5.7", "MIC.6.8", "PSA.1.1", "MAT.28.19",
    "EPH.6.11", "PSA.118.24", "COL.3.23", "PRO.18.10", "GAL.6.9",
    "PSA.103.1", "MAT.7.7", "ROM.12.12", "1CO.10.13", "PSA.16.11",
    "2CO.5.17", "HEB.4.12", "PSA.139.14", "PRO.3.6", "1JN.1.9",
    "ISA.26.3", "MAT.19.26", "ROM.8.31", "EPH.4.32", "PSA.55.22",
    "PRO.4.23", "PHP.4.6", "COL.3.17", "PSA.37.4", "1TH.5.18",
]
